...
import placeholder_img from '../assets/home/placeholder_img.png';
                ...
                <div className="main-content ml-5">
                    <div className="row py-2">
                        <div className="col-7">
                            ...
                            <p className="py-2">Automatically cut the video to only save frames in which the game is being played. Reduces video length up to 80%, and save you the space and time for warming ups, picking up the balls etc.</p>
                        </div>
                        <div className="col-5">
                            <img className="img-fluid" src={placeholder_img} alt="Auto-clipping illustration" />
                        </div>
                    </div>
                    ...
                    <div className="row py-2">
                        ...
                        <div className="col-7">
                            ...
                            <p className="py-2">Automatically detects the best rallies in your game, and applies visual effects to show your impactful strikes!</p>
                        </div>
                    </div>
                    ...
                    <div className="row py-2">
                        <div className="col-7">
                            ...
                            <p className="py-2">Detect the player's technique and provide detailed statistics on usage of different techniques, average strike speeds, forehands and backhands, and more.</p>
                        </div>
                        <div className="col-5">
                            <img className="img-fluid" src={placeholder_img} alt="Auto-clipping illustration" />
                        </div>
